...
urlpatterns = [
    ...
    path('cash-receipts/<int:pk>/delete/', views.cash_receipt_delete, name='cash_receipt_delete'),
    path('member-money-sends/', views.member_money_send_list, name='member_money_send_list'),
    path('member-money-sends/<int:pk>/delete/', views.member_money_send_delete, name='member_money_send_delete'),
